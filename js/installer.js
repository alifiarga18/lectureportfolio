...
async function createAdminAccount() {
    ...
    try {
        ...
        // Save site-config.json so other browsers/devices don't redirect to install.html
        try {
            if (hasLocalProxy()) {
            ...
            console.warn('Could not save site-config.json:', e.message);
            // Non-critical — user can manually create the file
        }
